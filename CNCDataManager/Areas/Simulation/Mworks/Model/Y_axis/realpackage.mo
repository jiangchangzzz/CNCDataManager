  ...
  package Drivers "控制驱动模型"
    model Servo
      ...
      annotation (Icon(graphics = {
        ...
        Rectangle(extent = {{-100, 100}, {100, -100}}, radius = 5, color = {0, 0, 0}, thickness = 0.5), 
        Text(extent = {{-69.8, -77.85}, {54.81, -99.57}}, color = {0, 0, 0}, textString = "ServoDriver"), 
  ...
  model RollingGuide "滚动导轨"
    ...
    Modelica.Blocks.Interfaces.RealInput m "工件的质量" 
      annotation (Placement(transformation(origin = {-122, 12}, rotation = -90, extent = {{22.19, 44.37}, {66.56, 88.75}}), 
        iconTransformation(origin = {-58, 76}, rotation = -90, extent = {{8.474, 16.94}, {28, 40}})));
    Modelica.Blocks.Interfaces.RealInput Fz "法向切削力" 
      annotation (Placement(transformation(origin = {-7, 20}, rotation = -90, extent = {{-55.47, -88.75}, {-16, -43}}), 
        iconTransformation(origin = {47, 46}, rotation = -90, extent = {{-21.18, -33.9}, {-2, -11}})));
    Modelica.Blocks.Interfaces.RealInput v "工作台的移动速度" 
      annotation (Placement(transformation(extent = {{41.81, -58.19}, {86.19, -13.81}}), 
        iconTransformation(extent = {{89.53, -10.48}, {106.4, 6.475}})));
    Modelica.Blocks.Interfaces.RealOutput Ff "导轨的摩擦力" 
      annotation (Placement(transformation(origin = {-8, -3}, rotation = 180, extent = {{-88.75, -77.65}, {-44.37, -33.28}}), 
        iconTransformation(origin = {-114, -25}, rotation = 180, extent = {{-33.9, -29.66}, {-16.94, -12.71}})));
    annotation (Icon(graphics = {
      Text(extent = {{-20.78, 45.12}, {7.439, 16.01}}, textString = ""), 
      Text(extent = {{-62.41, 70.58}, {-43.99, 53.99}}, textString = "m"), 
      Text(extent = {{35.56, 66.51}, {48.34, 53.37}}, textString = "Fz"), 
      Text(extent = {{87.62, 22.57}, {108.2, 1.309}}, textString = "v"), 
      Text(extent = {{-113.1, 3.147}, {-96.53, -13.51}}, textString = "Ff"), 
      Bitmap(extent = {{-74, 48}, {96, -72}}, fileName = "..\\pictures\\滚动导轨.jpg"), 
      ...
      Text(extent = {{-60, 30}, {70, -50}}, textString = "RollingGuide")}));
  equation 
  ...
  model SimpleProjectWorktable "简化模型的工作台"
    ...
    Modelica.Blocks.Interfaces.RealInput Ff "导轨的摩擦力" 
      annotation (Placement(transformation(origin = {-156, -38}, rotation = 180, extent = {{-108, -128}, {-72, -94}}), 
        iconTransformation(origin = {-72, -38}, rotation = 180, extent = {{-16.18, -22.65}, {-6.472, -9.709}})));
    Modelica.Blocks.Interfaces.RealInput Fz "法向切削力" 
      annotation (Placement(transformation(origin = {-129, 97.68}, rotation = -90, extent = {{41.13, 41.13}, {68.56, 68.56}}), 
        iconTransformation(origin = {32, 56}, rotation = -90, extent = {{15.71, 15.71}, {26.18, 26.18}})));
    Modelica.Blocks.Interfaces.RealInput Fx "进给力" 
      annotation (Placement(transformation(origin = {-36, 40}, rotation = 180, extent = {{27.19, 28.43}, {54.84, 54.84}}), 
        iconTransformation(origin = {-52, 20}, rotation = 180, extent = {{4, -1.691e-6}, {14, 12}})));
    annotation (Icon(graphics = {
      Text(extent = {{6.8, -60.98}, {30.1, -83.69}}, textString = "phix"), 
      Text(extent = {{-74.75, -29.32}, {-60.35, -43.35}}, textString = "Ff"), 
      Text(extent = {{43.25, 54.68}, {57.65, 40.65}}, textString = "Fz"), 
      Text(extent = {{-70.75, 30.68}, {-56.35, 16.65}}, textString = "Fx"), 
      Text(extent = {{85.25, 22.68}, {99.65, 8.65}}, textString = "a"), 
      Text(extent = {{85.25, 0.6796}, {99.65, -13.35}}, textString = "X"), 
      Text(extent = {{87.25, -17.32}, {101.7, -31.35}}, textString = "v"), 
      Text(extent = {{-4.75, 56.68}, {9.651, 42.65}}, textString = "m"), 
      Text(extent = {{-38.75, 50.68}, {-24.35, 36.65}}, textString = "Ts"), 
      ...
      Text(extent = {{-36, 8}, {70, -30}}, textString = "Worktable")}));
    parameter Modelica.SIunits.Mass M = 100 "工作台质量";
    ...
    Modelica.Blocks.Interfaces.RealInput m "工件的质量" 
      annotation (Placement(transformation(origin = {-122, 30}, rotation = -90, extent = {{41.13, 41.13}, {68.56, 68.56}}), 
        iconTransformation(origin = {-18, 56}, rotation = -90, extent = {{15.71, 15.71}, {26.18, 26.18}})));
    Modelica.Blocks.Interfaces.RealOutput Ts "负载转矩" 
      annotation (Placement(transformation(extent = {{78.29, -83.71}, {105.7, -56.29}}), 
        iconTransformation(extent = {{-45.48, 39.9}, {-36, 52}})));
  ...
  model Y_axis_Mechnical_model
    ...
    annotation (Diagram(coordinateSystem(preserveAspectRatio = false, 
      ...
      Icon(coordinateSystem(preserveAspectRatio = false, 
        ...
        Text(extent = {{-97.74, 41.04}, {-60, 26}}, textString = "Fx"), 
        ...
        Text(extent = {{-76, 28}, {70, -50}}, textString = "Y_axis_mechnical_model"), 
        Bitmap(extent = {{-60, 40}, {60, -40}}, fileName = "..\\pictures\\传动机构.bmp")}));
    Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_a "(left) driving flange (flange axis directed in to cut plane)" 
      annotation (Placement(transformation(extent = {{-138, -30}, {-118, -10}}), 
        iconTransformation(extent = {{-88, -46}, {-72, -28}})));
    Modelica.Blocks.Interfaces.RealOutput a "工作台的加速度" 
      annotation (Placement(transformation(extent = {{265.8, 77.82}, {278.2, 90.18}}), 
        iconTransformation(extent = {{90, 24}, {106, 44}})));
    Modelica.Blocks.Interfaces.RealOutput X "工作台的位移" 
      annotation (Placement(transformation(extent = {{265.8, 65.82}, {278.2, 78.18}}), 
        iconTransformation(extent = {{90, -8}, {104, 12}})));
    Modelica.Blocks.Interfaces.RealOutput v "工作台的速度" 
      annotation (Placement(transformation(extent = {{265.8, 53.82}, {278.2, 66.18}}), 
        iconTransformation(extent = {{90, -40}, {106, -20}})));
    Modelica.Blocks.Interfaces.RealInput m "工件的质量" 
      annotation (Placement(transformation(origin = {152, 142}, rotation = -90, extent = {{-7.638, -7.638}, {7.638, 7.638}}), 
        iconTransformation(origin = {-10, 42}, rotation = -90, extent = {{-7.638, -7.638}, {7.638, 7.638}})));
    Modelica.Blocks.Interfaces.RealInput Fz "法向切削力" 
      annotation (Placement(transformation(origin = {206, 134}, rotation = -90, extent = {{-7.638, -7.638}, {7.638, 7.638}}), 
        iconTransformation(origin = {56, 42}, rotation = -90, extent = {{-7.638, -7.638}, {7.638, 7.638}})));
    Modelica.Blocks.Interfaces.RealInput Fx "进给力" 
      annotation (Placement(transformation(origin = {90, 112}, rotation = -90, extent = {{-7.638, -7.638}, {7.638, 7.638}}), 
        iconTransformation(origin = {-80, 20}, extent = {{-7.638, -7.638}, {7.638, 7.638}})));
    FixedBearing fixedbearing
      annotation (Placement(iconTransformation(extent = {{-60, -60}, {-40, -40}}), 
        transformation(extent = {{-94.18, -82.18}, {-41.82, -29.82}})));
    OppositeFixedEndBearing oppositefixedendbearing
      annotation (Placement(iconTransformation(extent = {{20, -50}, {40, -30}}), 
        transformation(extent = {{33.82, -84.18}, {86.18, -31.82}})));
  equation 
    connect(coupling.flange_b, simpleprojectscrew.flange_a)
      annotation (Line(color = {0, 0, 0}, points = {{-71, -3}, {-34, -3}, {-34, -2}}));
    connect(simpleprojectscrew.phix, simpleprojectworktable.phix)
      annotation (Line(points = {{55, 27}, {167, 27}, {167, 37}}, color = {0, 0, 127}));
    connect(rollingguide.Ff, simpleprojectworktable.Ff)
      annotation (Line(points = {{120, -44}, {100, -44}, {100, 59}, {98, 59}}, color = {0, 0, 127}));
    connect(simpleprojectscrew.Ts, simpleprojectworktable.Ts)
      annotation (Line(points = {{7, 33}, {7, 30}, {13, 30}, {13, 133}, {126, 133}, 
        {126, 102}, {115, 102}}, color = {0, 0, 127}));
    connect(rollingguide.v, simpleprojectworktable.v)
      annotation (Line(points = {{215, -43}, {226, -43}, {226, 57}}, color = {0, 0, 127}));
    ...
    connect(simpleprojectworktable.a, a)
      annotation (Line(points = {{226, 82}, {238, 82}, {238, 84}, {272, 84}}, color = {0, 0, 127}));
    connect(simpleprojectworktable.X, X)
      annotation (Line(points = {{226, 69}, {272, 69}, {272, 72}}, color = {0, 0, 127}));
    connect(simpleprojectworktable.v, v)
      annotation (Line(points = {{226, 57}, {272, 57}, {272, 60}}, color = {0, 0, 127}));
    connect(simpleprojectworktable.m, m)
      annotation (Line(points = {{153, 95}, {153, 142}, {152, 142}}, color = {0, 0, 127}));
    connect(simpleprojectworktable.Fz, Fz)
      annotation (Line(points = {{197, 95}, {197, 124}, {206, 124}, {206, 134}}, color = {0, 0, 127}));
    connect(simpleprojectworktable.Fx, Fx)
      annotation (Line(points = {{98, 82}, {90, 82}, {90, 112}}, color = {0, 0, 127}));
    connect(rollingguide.Fz, Fz)
      annotation (Line(points = {{178, -17}, {178, 17}, {229, 17}, {229, 134}, {206, 134}}, color = {0, 0, 127}));
    connect(rollingguide.m, m)
      annotation (Line(points = {{150, -17}, {150, 142}, {152, 142}}, color = {0, 0, 127}));
    connect(fixedbearing.Tf1, simpleprojectscrew.Tf1)
      annotation (Line(points = {{-47, -63}, {-9, -63}, {-9, -8}}, color = {0, 0, 127}));
    connect(oppositefixedendbearing.Tf2, simpleprojectscrew.Tf2)
      annotation (Line(points = {{48, -63}, {32, -63}, {32, -8}}, color = {0, 0, 127}));
  end Y_axis_Mechnical_model;
  model Y_axis_model
    annotation (Diagram(coordinateSystem(preserveAspectRatio = false, 
      extent = {{-100, -100}, {260, 120}})), 
      Icon(coordinateSystem(preserveAspectRatio = false, 
        ...
        Rectangle(extent = {{-90, 50}, {90, -50}}, radius = 5, color = {0, 0, 0}, pattern = LinePattern.Solid, thickness = 0.5), 
        Text(extent = {{18.26, 73.04}, {88.62, 56.73}}, textString = "Fz"), 
        Text(extent = {{-87.74, 77.04}, {-50, 62}}, textString = "Fy"), 
        Text(extent = {{-33.74, 71.04}, {14, 52}}, textString = "m"), 
        ...
        Text(extent = {{-68, -36}, {74, -102}}, textString = "Y_axis_model"), 
        Text(extent = {{-155.4, 7.688}, {-94.34, -16.65}}, textString = "phi_ref")}));
    Y_axis_Mechnical_model y_axis_mechnical_model
      annotation (Placement(iconTransformation(extent = {{-20, 40}, {16, 62}}), 
        transformation(extent = {{134.3, -109}, {533.7, 135}})));
    PMSM pmsm
      annotation (Placement(iconTransformation(extent = {{40, -20}, {60, 0}}), 
        transformation(extent = {{67.82, -64.18}, {120.2, -11.82}})));
    Drivers.Servo servo
      annotation (Placement(iconTransformation(extent = {{-30, -20}, {-10, 0}}), 
        transformation(extent = {{-62.37, -52.37}, {22.37, 32.37}})));
...
Modelica.Blocks.Sources.Sine sine   
  ...
  equation 
    connect(servo.negativeplug, pmsm.positiveplug)
      annotation (Line(points = {{28, -5}, {64, -5}, {64, -38}}));
    connect(pmsm.flange_a, y_axis_mechnical_model.flange_a)
      annotation (Line(color = {0, 0, 0}, points = {{124, -39}, {234, -39}}));
    connect(servo.flange_a, pmsm.flange_a)
      annotation (Line(color = {0, 0, 0}, points = {{-37, 38}, {-37, 80}, {173, 80}, {173, -39}, {124, -39}}));
   
    connect(y_axis_mechnical_model.m, m)
      annotation (Line(points = {{304, 48}, {304, 110}, {310, 110}, {310, 120}}, color = {0, 0, 127}));
    connect(y_axis_mechnical_model.Fz, Fz)
      annotation (Line(points = {{370, 48}, {370, 120}}, color = {0, 0, 127}));
    connect(y_axis_mechnical_model.a, a)
      annotation (Line(points = {{412, 40}, {412, 44}, {464, 44}}, color = {0, 0, 127}));
    connect(y_axis_mechnical_model.X, X)
      annotation (Line(points = {{411, 4}, {466, 4}, {466, 6}}, color = {0, 0, 127}));
    connect(y_axis_mechnical_model.v, v)
