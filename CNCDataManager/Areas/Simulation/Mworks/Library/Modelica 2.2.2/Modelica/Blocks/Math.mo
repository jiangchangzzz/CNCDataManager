...
<img src=\"./Images/Blocks/ConvertAllUnits.png\">
    ...
    block To_degC "Convert from Kelvin to ¡æelsius" 
      ...
      annotation (Icon(Text(
            ...
            style(color=0),
            string="¡æ")), Documentation(info="<html>
<p>
This block converts the input signal from Kelvin to ¡æelsius and returns
the result as output signal.
    ...
    block From_degC "Convert from ¡æelsius to Kelvin" 
...
<p>
This block converts the input signal from ¡æelsius to Kelvin and returns
the result as output signal.
</p>
</html>"));
    equation 
    ...
    block To_degF "Convert from Kelvin to ¨Hahrenheit" 
      extends Modelica.Blocks.Interfaces.PartialConversionBlock(u(unit="K"), y(
            unit="degF"));
      annotation (Icon(Text(
            extent=[-20, 100; -100, 20],
            ...
            extent=[100, -20; 20, -100],
            style(color=0),
            string="¨H")), Documentation(info="<html>
<p>
This block converts the input signal from Kelvin to ¨Hahrenheit and returns
the result as output signal.
</p>
</html>"));
    equation 
    ...
    block From_degF "Convert from ¨Hahrenheit to Kelvin" 
      ...
      annotation (Icon(Text(
            ...
            string="K")), Documentation(info="<html>
<p>
This block converts the input signal from ¨Hahrenheit to Kelvin and returns
the result as output signal.
</p>
</html>"));
    equation 
    ...
    block To_degRk "Convert from Kelvin to ¡ãankine" 
      extends Modelica.Blocks.Interfaces.PartialConversionBlock(u(unit="K"), y(
            unit="degRk"));
      annotation (Icon(Text(
            extent=[-20, 100; -100, 20],
            ...
            extent=[100, -20; 20, -100],
            style(color=0),
            string="¡ãk")), Documentation(info="<html>
<p>
This block converts the input signal from Kelvin to ¡ãankine and returns
the result as output signal.
</p>
</html>"));
    equation 
    ...
    block From_degRk "Convert from ¡ãankine to Kelvin" 
      ...
      annotation (Icon(Text(
            ...
            string="K")), Documentation(info="<html>
<p>
This block converts the input signal from ¡ãankine to Kelvin and returns
the result as output signal.
</p>
</html>"));
    equation 
