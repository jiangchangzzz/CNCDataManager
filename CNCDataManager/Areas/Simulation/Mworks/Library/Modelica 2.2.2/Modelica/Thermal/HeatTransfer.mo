...
"));
  ...
  package Celsius "Components with Celsius input and/or output" 
    ...
    model ToKelvin "Conversion block from ¡æelsius to Kelvin" 
      annotation (
        Diagram(
...
"));
    ...
    model FromKelvin "Conversion from Kelvin to ¡æelsius" 
      annotation (
        Icon(
          Text(extent=[-137, 99; 132, 49], string="%name"),
          Ellipse(extent=[-40, 40; 40, -40], style(
...
"),     Diagram(
    ...
    model PrescribedTemperature 
      "Variable temperature boundary condition in ¡æelsius" 
...
"), Icon(
        Text(
          ...
          string="¡æ",
          style(color=0))));
    model TemperatureSensor "Absolute temperature sensor in ¡æelsius" 
...
"));
  ...
  package Rankine "Components with Rankine input and/or output" 
    ...
    model ToKelvin "Conversion block from ¡ãankine to Kelvin" 
      parameter Integer n=1 "Number of inputs (= number of outputs)";
      annotation (
        Diagram(
          Ellipse(extent=[-40, 40; 40, -40], style(
...
"));
    ...
    model FromKelvin "Conversion from Kelvin to ¡ãankine" 
      parameter Integer n=1 "Number of inputs (= number of outputs)";
      annotation (
        Icon(
          Text(extent=[-137, 99; 132, 49], string="%name"),
...
"));
    ...
    model FixedTemperature "Fixed temperature boundary condition in ¡ãankine" 
...
"),     Diagram(
    ...
    model PrescribedTemperature 
      "Variable temperature boundary condition in ¡ãankine" 
...
"), Icon(
        Text(
          ...
          string="¡ãk",
          style(color=0))));
    model TemperatureSensor "Absolute temperature sensor in ¡ãankine" 
