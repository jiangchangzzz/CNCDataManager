...
"), Icon(Text(
    ...
    function to_degC "Convert from Kelvin to ¡æelsius" 
    ...
    function from_degC "Convert from ¡æelsius to Kelvin" 
      extends ConversionIcon;
    ...
    function to_degF "Convert from Kelvin to ¨Hahrenheit" 
      extends ConversionIcon;
      input Temperature Kelvin "Kelvin value";
    ...
    function from_degF "Convert from ¨Hahrenheit to Kelvin" 
      extends ConversionIcon;
    ...
    function to_degRk "Convert from Kelvin to ¡ãankine" 
      extends ConversionIcon;
      input Temperature Kelvin "Kelvin value";
    ...
    function from_degRk "Convert from ¡ãankine to Kelvin" 
      extends ConversionIcon;
